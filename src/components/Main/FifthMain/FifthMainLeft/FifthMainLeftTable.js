import FifthMainLeftTableItem from "./FifthMainLeftTableItem";

const FifthMainLeftTable = () => {
  const fifthMainLeftTableContent = [
    {
      id: 1,
      icon: (
        <svg
    ...
    },
    {
      ...
      img: "https://demos.creative-tim.com/vision-ui-dashboard-react/static/media/avatar3.4d26ce02.png",
      price: "Not set",
      divStyle: "w-full",
      percent: "100%",
    },
    {
      ...
      img: "https://demos.creative-tim.com/vision-ui-dashboard-react/static/media/avatar4.2a4ba26c.png",
      price: "$20,500",
      divStyle: "w-full",
      percent: "100%",
    },
  ...
  return (
    <div className="mt-8">
      <div className="flex w-full text-[#86848e] text-[10px] font-bold mb-3">
        <span className="w-[45%]">COMPANIES</span>
        <span className="w-[15%]">MEMBERS</span>
        <span className="w-[18%]">BUDGET</span>
        <span className="w-[22%]">COMPLETION</span>
      </div>
      {fifthMainLeftTableContent.map((item) => (
        <FifthMainLeftTableItem
          key={item.id}
          icon={item.icon}
          title={item.title}
          img={item.img}
...
export default FifthMainLeftTable;
